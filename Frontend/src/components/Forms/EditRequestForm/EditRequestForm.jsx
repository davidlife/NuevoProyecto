...
export function EditRequestForm({requests,reqx}) {

	const initialValues = {
		isFragile: reqx.isFragile,
		width: `${reqx.width}`,
		height: `${reqx.height}`,
		depth: `${reqx.depth}`,
		weight: `${reqx.width}`,
		...
		dueHour: '12:00:00',
		state: `${reqx.state}`,
		fromCity: `${reqx.fromCity}`,
		fromAddress: `${reqx.fromAddress}`,
		toCity: `${reqx.toCity}`,
		toAddress: `${reqx.toAddress}`,
		toOwner: `${reqx.toOwner}`,
		toOwnerId: `${reqx.toOwnerId}`,
	};
	...
	return (
		<Form
			...
			action={`/client/requests/edit/${requests}`} 
			method="put"
		>
			{/* Destinatario */}
